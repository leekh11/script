...
<head>
<meta charset="UTF-8">
<title>/WEB_INF/error/error500.jsp</title>
</head>
<body>
...
<h2 class="tit_error">원하시는 페이지를  <span class="emph_txt">찾을수가 없습니다.</span></h2>
<p class="desc_error">
...
<div class="wrap_form">
<form action="http://search.google.com/search">
<fieldset>
...
<div class="info_link">
<a href="http://localhost:8080/study/07" class="link_error">제니 첫화면</a>
<a href="http://cs.daum.net/" class="link_error ">고객센터</a>
</div>
</div>
<hr class="hide">
<div id="kakaoFoot" class="foot_error" role="contentinfo">
<small class="info_copyright">Copyright &copy; Jenny Corp.All rights reserved.</small>
</div>
</div>
