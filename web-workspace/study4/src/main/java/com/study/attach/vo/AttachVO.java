...
public class AttachVO implements Serializable {
	...
	public AttachVO(int atchNo, int atchParentNo, String atchCategory, String atchFileName, String atchOriginalName,
			long atchFileSize, String atchFancySize, String atchContentType, String atchPath, int atchDownHit,
			String atchDelYn, String atchRegDate) {
		super();
		this.atchNo = atchNo;
